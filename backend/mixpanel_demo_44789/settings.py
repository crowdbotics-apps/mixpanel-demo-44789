"""
Django settings for mixpanel_demo_44789 project.
...
ROOT_URLCONF = 'mixpanel_demo_44789.urls'
...
WSGI_APPLICATION = 'mixpanel_demo_44789.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mixpanel_demo_44789 API",
    "DESCRIPTION": "API documentation for mixpanel_demo_44789 App",
    "VERSION": "v1",
}
